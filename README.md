...
选择选项 `3` 停止正在运行的 supernode 服务，脚本会自动查找并杀死 supernode 进程。
...
若您正在使用本项目并有新的需求或发现 bug，请向本项目报告，一般 3-7 天内会给出答复。后期可能会根据项目星星数量增加更多功能。由于项目时效性，会每隔 2-4 月进行运行测试以确保正常运行。

## 作者的话：卧槽，TRAE真tm好用，之前用腾讯元宝都在吃大便，亏老子还给她开发个接口
